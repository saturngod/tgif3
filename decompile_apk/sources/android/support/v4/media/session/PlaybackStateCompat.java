...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01231();
    ...
    static class C01231 implements Creator<PlaybackStateCompat> {
        C01231() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01241();
        ...
        static class C01241 implements Creator<CustomAction> {
            C01241() {
            }
    ...
    public static int toKeyCode(long j) {
        return j == 4 ? KEYCODE_MEDIA_PLAY : j == 2 ? 127 : j == 32 ? 87 : j == 16 ? 88 : j == 1 ? 86 : j == 64 ? 90 : j == 8 ? 89 : j == 512 ? 85 : 0;
    }
