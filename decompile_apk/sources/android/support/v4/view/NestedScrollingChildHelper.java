...
public class NestedScrollingChildHelper {
    ...
    public boolean dispatchNestedScroll(int i, int i2, int i3, int i4, @Nullable int[] iArr, int i5) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            if (iArr2 != null) {
                nestedScrollingChildHelper.mView.getLocationInWindow(iArr2);
                i6 = iArr2[0];
                i7 = iArr2[1];
            } else {
                i6 = 0;
            ...
            ViewParentCompat.onNestedScroll(nestedScrollingParentForType, nestedScrollingChildHelper.mView, i, i2, i3, i4, i5);
            if (iArr2 != null) {
                nestedScrollingChildHelper.mView.getLocationInWindow(iArr2);
                iArr2[0] = iArr2[0] - i6;
                iArr2[1] = iArr2[1] - i7;
