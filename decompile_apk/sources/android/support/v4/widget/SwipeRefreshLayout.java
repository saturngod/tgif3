...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C01671 implements AnimationListener {
    ...
    class C01682 extends Animation {
        C01682() {
        }
    ...
    class C01693 extends Animation {
        C01693() {
        }
    ...
    class C01715 implements AnimationListener {
        public void onAnimationRepeat(Animation animation) {
        }
    ...
    class C01726 extends Animation {
        C01726() {
        }
    ...
    class C01737 extends Animation {
        C01737() {
        }
    ...
    class C01748 extends Animation {
        C01748() {
        }
    ...
    public SwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.mRefreshListener = new C01671();
        this.mAnimateToCorrectPosition = new C01726();
        this.mAnimateToStartPosition = new C01737();
    ...
    private void startScaleUpAnimation(AnimationListener animationListener) {
        ...
        this.mScaleAnimation = new C01682();
    ...
    void startScaleDownAnimation(AnimationListener animationListener) {
        this.mScaleDownAnimation = new C01693();
    ...
    private Animation startAlphaAnimation(final int i, final int i2) {
        Animation c01704 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                SwipeRefreshLayout.this.mProgress.setAlpha((int) (((float) i) + (((float) (i2 - i)) * f)));
            }
        };
        c01704.setDuration(ALPHA_ANIMATION_DURATION);
        this.mCircleView.setAnimationListener(0);
        this.mCircleView.clearAnimation();
        this.mCircleView.startAnimation(c01704);
        return c01704;
    }
    ...
    private void startScaleDownReturnToStartAnimation(int i, AnimationListener animationListener) {
        ...
        this.mScaleDownToStartAnimation = new C01748();
