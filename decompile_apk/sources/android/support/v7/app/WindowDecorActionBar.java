...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C03053();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C03053 implements ViewPropertyAnimatorUpdateListener {
        C03053() {
        }
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0192R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0192R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0192R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0192R.id.action_bar_container);
        ...
        if (!actionBarPolicy.enableHomeButtonByDefault()) {
            if (view == null) {
                ...
                view = this.mContext.obtainStyledAttributes(null, C0192R.styleable.ActionBar, C0192R.attr.actionBarStyle, 0);
                if (view.getBoolean(C0192R.styleable.ActionBar_hideOnContentScroll, false)) {
                    setHideOnContentScrollEnabled(true);
                }
                dimensionPixelSize = view.getDimensionPixelSize(C0192R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0192R.attr.actionBarWidgetTheme, typedValue, true);
