...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    private static final int ITEM_LAYOUT = C0192R.layout.abc_cascading_menu_item_layout;
    static final int SUBMENU_TIMEOUT_MS = 200;
    private View mAnchorView;
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C01962();
    private final Context mContext;
    private int mDropDownGravity = 0;
    private boolean mForceShowIcon;
    final OnGlobalLayoutListener mGlobalLayoutListener = new C01951();
    private boolean mHasXOffset;
    private boolean mHasYOffset;
    private int mLastPosition;
    private final MenuItemHoverListener mMenuItemHoverListener = new C03063();
    ...
    class C01951 implements OnGlobalLayoutListener {
        C01951() {
        }
    ...
    class C01962 implements OnAttachStateChangeListener {
    ...
    class C03063 implements MenuItemHoverListener {
        C03063() {
        }
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View view, @AttrRes int i, @StyleRes int i2, boolean z) {
        ...
        this.mMenuMaxWidth = Math.max(context.getDisplayMetrics().widthPixels / 2, context.getDimensionPixelSize(C0192R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (cascadingMenuInfo == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) from.inflate(C0192R.layout.abc_popup_menu_header_item_layout, listView, false);
