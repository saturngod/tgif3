...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C02041 extends AnimatorListenerAdapter {
        C02041() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C02041();
        this.mRemoveActionBarHideOffset = new C02052();
        this.mAddActionBarHideOffset = new C02063();
        init(context);
