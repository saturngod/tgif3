...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C02213 implements OnFocusChangeListener {
        C02213() {
        }
    ...
    class C02224 implements OnLayoutChangeListener {
        C02224() {
        }
    ...
    class C02246 implements OnKeyListener {
        C02246() {
        }
    ...
    class C02257 implements OnEditorActionListener {
        C02257() {
        }
    ...
    class C02268 implements OnItemClickListener {
        C02268() {
        }
    ...
    class C02279 implements OnItemSelectedListener {
...
*/
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C02281 implements ClassLoaderCreator<SavedState> {
            C02281() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0192R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attributeSet, int i) {
            super(context, attributeSet, i);
            this.mRunShowSoftInputIfNecessary = new C02291();
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0192R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateDrawableStateRunnable = new C02191();
        this.mReleaseCursorRunnable = new C02202();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02235();
        this.mTextKeyListener = new C02246();
        this.mOnEditorActionListener = new C02257();
        this.mOnItemClickListener = new C02268();
        this.mOnItemSelectedListener = new C02279();
        ...
        attributeSet = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0192R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(attributeSet.getResourceId(C0192R.styleable.SearchView_layout, C0192R.layout.abc_search_view), this, true);
        ...
        ViewCompat.setBackground(this.mSearchPlate, attributeSet.getDrawable(C0192R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, attributeSet.getDrawable(C0192R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(attributeSet.getDrawable(C0192R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(attributeSet.getDrawable(C0192R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(attributeSet.getDrawable(C0192R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(attributeSet.getDrawable(C0192R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(attributeSet.getDrawable(C0192R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = attributeSet.getDrawable(C0192R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0192R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = attributeSet.getResourceId(C0192R.styleable.SearchView_suggestionRowLayout, C0192R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = attributeSet.getResourceId(C0192R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C02213());
        setIconifiedByDefault(attributeSet.getBoolean(C0192R.styleable.SearchView_iconifiedByDefault, true));
        context = attributeSet.getDimensionPixelSize(C0192R.styleable.SearchView_android_maxWidth, -1);
        if (context != -1) {
            setMaxWidth(context);
        }
        this.mDefaultQueryHint = attributeSet.getText(C0192R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = attributeSet.getText(C0192R.styleable.SearchView_queryHint);
        context = attributeSet.getInt(C0192R.styleable.SearchView_android_imeOptions, -1);
        if (context != -1) {
            setImeOptions(context);
        }
        context = attributeSet.getInt(C0192R.styleable.SearchView_android_inputType, -1);
        if (context != -1) {
            setInputType(context);
        }
        setFocusable(attributeSet.getBoolean(C0192R.styleable.SearchView_android_focusable, true));
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C02224());
        }
    ...
    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0192R.dimen.abc_search_view_preferred_height);
    }
...
*/
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0192R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0192R.dimen.abc_dropdownitem_text_padding_left) : 0;
