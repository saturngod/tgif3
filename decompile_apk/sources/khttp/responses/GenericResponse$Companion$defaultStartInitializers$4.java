...
final class GenericResponse$Companion$defaultStartInitializers$4 extends Lambda implements Function2<GenericResponse, HttpURLConnection, Unit> {
    ...
    public final void invoke(@NotNull GenericResponse genericResponse, @NotNull HttpURLConnection httpURLConnection) {
        ...
        genericResponse = (int) (genericResponse.getRequest().getTimeout() * 1000.0d);
        httpURLConnection.setConnectTimeout(genericResponse);
        httpURLConnection.setReadTimeout(genericResponse);
    }
}
