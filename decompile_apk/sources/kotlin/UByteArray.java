...
public final class UByteArray implements Collection<UByte>, KMappedMarker {
    ...
    @NotNull
    @PublishedApi
    public static byte[] constructor-impl(@NotNull byte[] bArr) {
        Intrinsics.checkParameterIsNotNull(bArr, "storage");
        return bArr;
    }

    public static boolean equals-impl(byte[] bArr, @Nullable Object obj) {
        return (obj instanceof UByteArray) && Intrinsics.areEqual((Object) bArr, ((UByteArray) obj).unbox-impl());
    }

    public static final boolean equals-impl0(@NotNull byte[] bArr, @NotNull byte[] bArr2) {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        return obj instanceof UByte ? contains-7apg3OU(((UByte) obj).unbox-impl()) : null;
    }
    ...
    public static final byte get-impl(byte[] bArr, int i) {
        return UByte.constructor-impl(bArr[i]);
    }
    ...
    @NotNull
    public static UByteIterator iterator-impl(byte[] bArr) {
    ...
    public static boolean containsAll-impl(byte[] bArr, @NotNull Collection<UByte> collection) {
        Intrinsics.checkParameterIsNotNull(collection, "elements");
        Iterable<UByte> iterable = collection;
        if (((Collection) iterable).isEmpty()) {
            return true;
        }
        for (UByte unbox-impl : iterable) {
            if (!ArraysKt___ArraysKt.contains(bArr, unbox-impl.unbox-impl())) {
                return false;
            }
        }
        return true;
    ...
    public static boolean isEmpty-impl(byte[] bArr) {
        return bArr.length == null ? 1 : null;
    }
}
