...
public class TypeIntrinsics {
    ...
    public static boolean isMutableIterator(Object obj) {
        return (!(obj instanceof Iterator) || ((obj instanceof KMappedMarker) && (obj instanceof KMutableIterator) == null)) ? null : true;
    }
    ...
    public static boolean isMutableListIterator(Object obj) {
        return (!(obj instanceof ListIterator) || ((obj instanceof KMappedMarker) && (obj instanceof KMutableListIterator) == null)) ? null : true;
    }
    ...
    public static boolean isMutableIterable(Object obj) {
        return (!(obj instanceof Iterable) || ((obj instanceof KMappedMarker) && (obj instanceof KMutableIterable) == null)) ? null : true;
    }
    ...
    public static boolean isMutableCollection(Object obj) {
        return (!(obj instanceof Collection) || ((obj instanceof KMappedMarker) && (obj instanceof KMutableCollection) == null)) ? null : true;
    }
    ...
    public static boolean isMutableList(Object obj) {
        return (!(obj instanceof List) || ((obj instanceof KMappedMarker) && (obj instanceof KMutableList) == null)) ? null : true;
    }
    ...
    public static boolean isMutableSet(Object obj) {
        return (!(obj instanceof Set) || ((obj instanceof KMappedMarker) && (obj instanceof KMutableSet) == null)) ? null : true;
    }
    ...
    public static boolean isMutableMap(Object obj) {
        return (!(obj instanceof Map) || ((obj instanceof KMappedMarker) && (obj instanceof KMutableMap) == null)) ? null : true;
    }
    ...
    public static boolean isMutableMapEntry(Object obj) {
        return (!(obj instanceof Entry) || ((obj instanceof KMappedMarker) && (obj instanceof KMutableMap.Entry) == null)) ? null : true;
    }
    ...
    public static boolean isFunctionOfArity(Object obj, int i) {
        return ((obj instanceof Function) && getFunctionArity(obj) == i) ? true : null;
    }
    ...
    public static Object beforeCheckcastToFunctionOfArity(Object obj, int i, String str) {
        if (obj != null && isFunctionOfArity(obj, i) == 0) {
            throwCce(str);
        }
        return obj;
    }
