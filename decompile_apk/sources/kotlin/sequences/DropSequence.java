...
public final class DropSequence<T> implements Sequence<T>, DropTakeSequence<T> {
    ...
    public Sequence<T> drop(int i) {
        int i2 = this.count + i;
        return i2 < 0 ? new DropSequence(this, i) : (Sequence) new DropSequence(this.sequence, i2);
    }

    @NotNull
    public Sequence<T> take(int i) {
        int i2 = this.count + i;
        return i2 < 0 ? new TakeSequence(this, i) : (Sequence) new SubSequence(this.sequence, this.count, i2);
    }
