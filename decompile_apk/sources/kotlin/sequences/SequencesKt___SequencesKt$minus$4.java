...
public final class SequencesKt___SequencesKt$minus$4 implements Sequence<T> {
    ...
    public Iterator<T> iterator() {
        HashSet toHashSet = SequencesKt___SequencesKt.toHashSet(this.$elements);
        if (toHashSet.isEmpty()) {
            return this.$this_minus.iterator();
        }
        return SequencesKt___SequencesKt.filterNot(this.$this_minus, new SequencesKt___SequencesKt$minus$4$iterator$1(toHashSet)).iterator();
    }
}
