...
public final class BroadcastKt {
    ...
    public static final <E> BroadcastChannel<E> broadcast(@NotNull CoroutineScope coroutineScope, @NotNull CoroutineContext coroutineContext, int i, @NotNull CoroutineStart coroutineStart, @Nullable Function1<? super Throwable, Unit> function1, @NotNull @BuilderInference Function2<? super ProducerScope<? super E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        coroutineContext = BroadcastChannelKt.BroadcastChannel(i);
        if (coroutineStart.isLazy() != 0) {
            i = (BroadcastCoroutine) new LazyBroadcastCoroutine(coroutineScope, coroutineContext, function2);
        } else {
            i = new BroadcastCoroutine(coroutineScope, coroutineContext, true);
        }
        if (function1 != null) {
            i.invokeOnCompletion(function1);
        }
        i.start(coroutineStart, i, function2);
        return (BroadcastChannel) i;
    }
}
