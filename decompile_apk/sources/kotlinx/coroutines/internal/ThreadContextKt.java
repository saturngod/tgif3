...
public final class ThreadContextKt {
    ...
    public static final Object threadContextElements(@NotNull CoroutineContext coroutineContext) {
        ...
        coroutineContext = coroutineContext.fold(Integer.valueOf(0), countAll);
    ...
    public static final Object updateThreadContext(@NotNull CoroutineContext coroutineContext, @Nullable Object obj) {
        Intrinsics.checkParameterIsNotNull(coroutineContext, "context");
        if (obj == null) {
            Integer threadContextElements = threadContextElements(coroutineContext);
        }
        if (threadContextElements == Integer.valueOf(0)) {
            return ZERO;
        }
        if (threadContextElements instanceof Integer) {
            return coroutineContext.fold(new ThreadState(coroutineContext, threadContextElements.intValue()), updateState);
        }
