...
public final class ThreadLocalElement<T> implements ThreadContextElement<T> {
    @NotNull
    private final Key<?> key = ((Key) new ThreadLocalKey(this.threadLocal));
    ...
    public T updateThreadContext(@NotNull CoroutineContext coroutineContext) {
        Intrinsics.checkParameterIsNotNull(coroutineContext, "context");
        coroutineContext = this.threadLocal.get();
    ...
    public CoroutineContext minusKey(@NotNull Key<?> key) {
        ...
        return Intrinsics.areEqual(getKey(), (Object) key) != null ? (CoroutineContext) EmptyCoroutineContext.INSTANCE : this;
    }

    @Nullable
    public <E extends Element> E get(@NotNull Key<E> key) {
        Intrinsics.checkParameterIsNotNull(key, "key");
        return Intrinsics.areEqual(getKey(), (Object) key) != null ? this : null;
    }
