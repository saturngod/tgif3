...
public class _RelativeLayout extends RelativeLayout {
    ...
    public static /* synthetic */ View lparams$default(_RelativeLayout _relativelayout, View view, int i, int i2, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            ...
            Intrinsics.checkParameterIsNotNull(function1, "init");
            _relativelayout = new LayoutParams(i, i2);
            function1.invoke(_relativelayout);
            view.setLayoutParams((ViewGroup.LayoutParams) _relativelayout);
            return view;
        }
