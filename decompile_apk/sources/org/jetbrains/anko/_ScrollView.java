...
public class _ScrollView extends ScrollView {
    ...
    public static /* synthetic */ View lparams$default(_ScrollView _scrollview, View view, int i, int i2, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            ...
            Intrinsics.checkParameterIsNotNull(function1, "init");
            _scrollview = new LayoutParams(i, i2);
            function1.invoke(_scrollview);
            view.setLayoutParams((ViewGroup.LayoutParams) _scrollview);
            return view;
        }
    ...
    public static /* synthetic */ View lparams$default(_ScrollView _scrollview, View view, int i, int i2, int i3, Function1 function1, int i4, Object obj) {
        if (obj == null) {
            ...
            Intrinsics.checkParameterIsNotNull(view, "receiver$0");
            Intrinsics.checkParameterIsNotNull(function1, "init");
            _scrollview = new LayoutParams(i, i2, i3);
            function1.invoke(_scrollview);
            view.setLayoutParams((ViewGroup.LayoutParams) _scrollview);
            return view;
        }
