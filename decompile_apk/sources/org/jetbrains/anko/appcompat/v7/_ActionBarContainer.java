...
public class _ActionBarContainer extends ActionBarContainer {
    ...
    public static /* synthetic */ View lparams$default(_ActionBarContainer _actionbarcontainer, View view, int i, int i2, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            ...
            Intrinsics.checkParameterIsNotNull(function1, "init");
            _actionbarcontainer = new LayoutParams(i, i2);
            function1.invoke(_actionbarcontainer);
            view.setLayoutParams((ViewGroup.LayoutParams) _actionbarcontainer);
            return view;
        }
    ...
    public static /* synthetic */ View lparams$default(_ActionBarContainer _actionbarcontainer, View view, int i, int i2, int i3, Function1 function1, int i4, Object obj) {
        if (obj == null) {
            ...
            Intrinsics.checkParameterIsNotNull(view, "receiver$0");
            Intrinsics.checkParameterIsNotNull(function1, "init");
            _actionbarcontainer = new LayoutParams(i, i2, i3);
            function1.invoke(_actionbarcontainer);
            view.setLayoutParams((ViewGroup.LayoutParams) _actionbarcontainer);
            return view;
        }
