    ...
    public final void onInflate(final ViewStubCompat viewStubCompat, final View view) {
        BuildersKt.launch(GlobalScope.INSTANCE, this.$context, CoroutineStart.DEFAULT, new Function2<CoroutineScope, Continuation<? super Unit>, Object>(null) {
            ...
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                ...
                Continuation c03471 = /* anonymous class already generated */;
                c03471.p$ = (CoroutineScope) obj;
                return c03471;
            }

            public final Object invoke(Object obj, Object obj2) {
                return ((C03471) create(obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                switch (this.label) {
                    case 0:
                        ...
                        View view = view;
                        this.label = 1;
                        if (function4.invoke(obj, viewStubCompat, view, this) == coroutine_suspended) {
