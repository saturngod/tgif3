...
final class __SearchView_OnQueryTextListener$onQueryTextSubmit$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        Continuation __searchview_onquerytextlistener_onquerytextsubmit_1 = new __SearchView_OnQueryTextListener$onQueryTextSubmit$1(this.$handler, this.$query, continuation);
