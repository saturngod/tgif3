...
final class __SearchView_OnSuggestionListener$onSuggestionSelect$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        Continuation __searchview_onsuggestionlistener_onsuggestionselect_1 = new __SearchView_OnSuggestionListener$onSuggestionSelect$1(this.$handler, this.$position, continuation);
