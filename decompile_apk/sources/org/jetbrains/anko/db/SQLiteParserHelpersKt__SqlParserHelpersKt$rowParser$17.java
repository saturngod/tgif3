...
public final class SQLiteParserHelpersKt__SqlParserHelpersKt$rowParser$17 implements RowParser<R> {
    ...
    public R parseRow(@NotNull Object[] objArr) {
        ...
        if (obj.length == 17) {
            return this.$parser.invoke(obj[0], obj[1], obj[2], obj[3], obj[4], obj[5], obj[6], obj[7], obj[8], obj[9], obj[10], obj[11], obj[12], obj[13], obj[14], obj[15], obj[16]);
        }
        SQLiteParserHelpersKt__SqlParserHelpersKt$rowParser$17 sQLiteParserHelpersKt__SqlParserHelpersKt$rowParser$17 = this;
