...
final class Sdk27CoroutinesListenersWithCoroutinesKt$onCapturedPointer$1 implements OnCapturedPointerListener {
    final /* synthetic */ CoroutineContext $context;
    final /* synthetic */ Function4 $handler;
    final /* synthetic */ boolean $returnValue;

    Sdk27CoroutinesListenersWithCoroutinesKt$onCapturedPointer$1(CoroutineContext coroutineContext, Function4 function4, boolean z) {
        this.$context = coroutineContext;
        this.$handler = function4;
        this.$returnValue = z;
    }

    public final boolean onCapturedPointer(final View view, final MotionEvent motionEvent) {
        BuildersKt.launch(GlobalScope.INSTANCE, this.$context, CoroutineStart.DEFAULT, new Function2<CoroutineScope, Continuation<? super Unit>, Object>(null) {
            ...
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                ...
                Continuation c03531 = /* anonymous class already generated */;
                c03531.p$ = (CoroutineScope) obj;
                return c03531;
            }

            public final Object invoke(Object obj, Object obj2) {
                return ((C03531) create(obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
            }
