...
final class Sdk27CoroutinesListenersWithCoroutinesKt$onCheckedChange$1 implements OnCheckedChangeListener {
    final /* synthetic */ CoroutineContext $context;
    final /* synthetic */ Function4 $handler;

    Sdk27CoroutinesListenersWithCoroutinesKt$onCheckedChange$1(CoroutineContext coroutineContext, Function4 function4) {
    ...
    public final void onCheckedChanged(final CompoundButton compoundButton, final boolean z) {
        BuildersKt.launch(GlobalScope.INSTANCE, this.$context, CoroutineStart.DEFAULT, new Function2<CoroutineScope, Continuation<? super Unit>, Object>(null) {
            ...
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                ...
                Continuation c03541 = /* anonymous class already generated */;
                c03541.p$ = (CoroutineScope) obj;
                return c03541;
            }

            public final Object invoke(Object obj, Object obj2) {
                return ((C03541) create(obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                switch (this.label) {
                    case 0:
                        ...
                        this.label = 1;
                        if (function4.invoke(obj, compoundButton, boxBoolean, this) == coroutine_suspended) {
