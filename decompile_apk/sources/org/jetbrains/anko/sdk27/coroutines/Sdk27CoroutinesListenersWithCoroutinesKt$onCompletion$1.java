...
final class Sdk27CoroutinesListenersWithCoroutinesKt$onCompletion$1 implements OnCompletionListener {
    ...
    public final void onCompletion(final MediaPlayer mediaPlayer) {
        BuildersKt.launch(GlobalScope.INSTANCE, this.$context, CoroutineStart.DEFAULT, new Function2<CoroutineScope, Continuation<? super Unit>, Object>(null) {
            ...
            public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
                ...
                Continuation c03591 = /* anonymous class already generated */;
                c03591.p$ = (CoroutineScope) obj;
                return c03591;
            }

            public final Object invoke(Object obj, Object obj2) {
                return ((C03591) create(obj, (Continuation) obj2)).invokeSuspend(Unit.INSTANCE);
            }
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                ...
                switch (this.label) {
                    case 0:
                        ...
                        this.label = 1;
                        if (function3.invoke(obj, mediaPlayer, this) == coroutine_suspended) {
