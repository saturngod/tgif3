...
final class __AbsListView_OnScrollListener$onScrollStateChanged$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        Continuation __abslistview_onscrolllistener_onscrollstatechanged_1 = new __AbsListView_OnScrollListener$onScrollStateChanged$1(this.$handler, this.$view, this.$scrollState, continuation);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (function4.invoke(obj, absListView, boxInt, this) == coroutine_suspended) {
