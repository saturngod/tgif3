...
final class __AdapterView_OnItemSelectedListener$onNothingSelected$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        Continuation __adapterview_onitemselectedlistener_onnothingselected_1 = new __AdapterView_OnItemSelectedListener$onNothingSelected$1(this.$handler, this.$p0, continuation);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (function3.invoke(obj, adapterView, this) == coroutine_suspended) {
