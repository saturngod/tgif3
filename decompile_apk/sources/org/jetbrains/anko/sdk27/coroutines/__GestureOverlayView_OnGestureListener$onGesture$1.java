...
final class __GestureOverlayView_OnGestureListener$onGesture$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        Continuation __gestureoverlayview_ongesturelistener_ongesture_1 = new __GestureOverlayView_OnGestureListener$onGesture$1(this.$handler, this.$overlay, this.$event, continuation);
