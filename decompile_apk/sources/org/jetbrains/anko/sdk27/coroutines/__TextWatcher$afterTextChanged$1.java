...
final class __TextWatcher$afterTextChanged$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        Continuation __textwatcher_aftertextchanged_1 = new __TextWatcher$afterTextChanged$1(this.$handler, this.$s, continuation);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (function3.invoke(obj, editable, this) == coroutine_suspended) {
