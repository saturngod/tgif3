...
final class __TextWatcher$beforeTextChanged$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        Continuation __textwatcher_beforetextchanged_1 = new __TextWatcher$beforeTextChanged$1(this.$handler, this.$s, this.$start, this.$count, this.$after, continuation);
