...
final class __ViewGroup_OnHierarchyChangeListener$onChildViewRemoved$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        Continuation __viewgroup_onhierarchychangelistener_onchildviewremoved_1 = new __ViewGroup_OnHierarchyChangeListener$onChildViewRemoved$1(this.$handler, this.$parent, this.$child, continuation);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (function4.invoke(obj, view, view2, this) == coroutine_suspended) {
