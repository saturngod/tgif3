...
final class __View_OnAttachStateChangeListener$onViewAttachedToWindow$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        Continuation __view_onattachstatechangelistener_onviewattachedtowindow_1 = new __View_OnAttachStateChangeListener$onViewAttachedToWindow$1(this.$handler, this.$v, continuation);
