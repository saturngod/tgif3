...
public class _DrawerLayout extends DrawerLayout {
    ...
    public static /* synthetic */ View lparams$default(_DrawerLayout _drawerlayout, View view, int i, int i2, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            ...
            Intrinsics.checkParameterIsNotNull(function1, "init");
            _drawerlayout = new LayoutParams(i, i2);
            function1.invoke(_drawerlayout);
            view.setLayoutParams((ViewGroup.LayoutParams) _drawerlayout);
            return view;
        }
    ...
    public static /* synthetic */ View lparams$default(_DrawerLayout _drawerlayout, View view, int i, int i2, int i3, Function1 function1, int i4, Object obj) {
        if (obj == null) {
            ...
            Intrinsics.checkParameterIsNotNull(view, "receiver$0");
            Intrinsics.checkParameterIsNotNull(function1, "init");
            _drawerlayout = new LayoutParams(i, i2, i3);
            function1.invoke(_drawerlayout);
            view.setLayoutParams((ViewGroup.LayoutParams) _drawerlayout);
            return view;
        }
