...
public class _NestedScrollView extends NestedScrollView {
    ...
    public static /* synthetic */ View lparams$default(_NestedScrollView _nestedscrollview, View view, int i, int i2, Function1 function1, int i3, Object obj) {
        if (obj == null) {
            ...
            Intrinsics.checkParameterIsNotNull(function1, "init");
            _nestedscrollview = new LayoutParams(i, i2);
            function1.invoke(_nestedscrollview);
            view.setLayoutParams((ViewGroup.LayoutParams) _nestedscrollview);
            return view;
        }
    ...
    public static /* synthetic */ View lparams$default(_NestedScrollView _nestedscrollview, View view, int i, int i2, int i3, Function1 function1, int i4, Object obj) {
        if (obj == null) {
            ...
            Intrinsics.checkParameterIsNotNull(view, "receiver$0");
            Intrinsics.checkParameterIsNotNull(function1, "init");
            _nestedscrollview = new LayoutParams(i, i2, i3);
            function1.invoke(_nestedscrollview);
            view.setLayoutParams((ViewGroup.LayoutParams) _nestedscrollview);
            return view;
        }
